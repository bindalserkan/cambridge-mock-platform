...
// Strict configuration mirroring the formal Cambridge C1 Advanced blueprint
export const CAE_CONFIG: Record<string, KETFieldConfig[]> = {
  reading: [
    { key: 'Part 1', label: 'Part 1', max: 8, step: 1 },
    { key: 'Part 5', label: 'Part 5', max: 6, step: 1 },
    { key: 'Part 6', label: 'Part 6', max: 4, step: 1 },
    { key: 'Part 7', label: 'Part 7', max: 6, step: 1 },
    { key: 'Part 8', label: 'Part 8', max: 10, step: 1 },
  ],
  useOfEnglish: [
