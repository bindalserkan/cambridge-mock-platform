...
// Strict configuration mirroring the formal Cambridge C2 Proficiency blueprint
export const CPE_CONFIG: Record<string, KETFieldConfig[]> = {
  reading: [
    { key: 'Part 1', label: 'Part 1', max: 8, step: 1 },
    { key: 'Part 5', label: 'Part 5', max: 6, step: 1 },
    { key: 'Part 6', label: 'Part 6', max: 7, step: 1 },
    { key: 'Part 7', label: 'Part 7', max: 10, step: 1 },
  ],
  useOfEnglish: [
    { key: 'Part 2', label: 'Part 2', max: 8, step: 1 },
    { key: 'Part 3', label: 'Part 3', max: 8, step: 1 },
    { key: 'Part 4 - Correct Answers', label: 'Part 4 - Correct Answers (2pts each)', max: 6, step: 1 },
    { key: 'Part 4 - Partly Correct Answers', label: 'Part 4 - Partly Correct Answers (1pt each)', max: 6, step: 1 },
  ],
  writing: [
  ...
  listening: [
    ...
    { key: 'Part 2', label: 'Part 2', max: 9, step: 1 },
    { key: 'Part 3', label: 'Part 3', max: 5, step: 1 },
    { key: 'Part 4', label: 'Part 4', max: 10, step: 1 },
  ],
  speaking: [
    { key: 'Grammatical Resource', label: 'Grammatical Resource', max: 5, step: 0.5 },
    { key: 'Lexical Resource', label: 'Lexical Resource', max: 5, step: 0.5 },
