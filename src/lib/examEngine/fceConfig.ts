...
// Reusing the same interface blueprint for strict architectural alignment
export const FCE_CONFIG: Record<string, KETFieldConfig[]> = {
  reading: [
  ...
  listening: [
    { key: 'Part 1', label: 'Part 1', max: 8, step: 1 },
    { key: 'Part 2', label: 'Part 2', max: 10, step: 1 },
    { key: 'Part 3', label: 'Part 3', max: 5, step: 1 },
    { key: 'Part 4', label: 'Part 4', max: 7, step: 1 },
  ],
  speaking: [
